...
listLigComm.map((lig,ind)=>{
  return (<div key={ind}>
         <div><img src={"images/"+lig.refarticle.couverture} alt="" width="40" />{lig.refarticle.titre} {lig.refarticle.titre} Quantité : {lig.quantitecommandee} Total : {lig.totligne}</div> 
  </div>)
}):null 
  }
   </Box>
