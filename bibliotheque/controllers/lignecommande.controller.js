...
export const createLigneCommande = async (req, res) => { 
    ...
    const newLigneCommande = new LigneCommande({  quantitecommandee:quantitecommandee, totligne:totligne,refarticle:refarticle,refcommande:refcommande  })
    try {  
...
export const updateLigneCommande= async (req, res) => {
    ...
    const lc1 = {  quantitecommandee:quantitecommandee, totligne:totligne, refarticle:refarticle,refcommande:refcommande,_id: id };
...
export const getLigneCommandeByIdCom = async (req, res) => {  
    try {
        const lc = await LigneCommande.find({ refcommande: req.params.refcommande}).populate('refcommande').populate('refarticle').exec();
